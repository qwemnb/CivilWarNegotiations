...
CREATE TABLE IF NOT EXISTS heather.negotiations_suggested (id int NOT NULL AUTO_INCREMENT, raw_data_id int NOT NULL, file_id int NOT NULL, question_id int NOT NULL, answer_year varchar(8), answer_month int, year_data, PRIMARY KEY (id), FOREIGN KEY (question_id) REFERENCES  heather.questions(id) ); 